...
//    public HashMap<String, MethodTable> methodTables = new HashMap<String, MethodTable>();
...
//        methodTables.put("main", mc_method);
        ClassTable mc_table = new ClassTable(mc_name);
        mc_table.methods.put(method_name, mc_method);
        classTables.put(mc_name, mc_table);
//        Boolean validFields = mc_table.addFields(mc_localVars);
//        Boolean validClassDeclaration = (classTables.put(mc_name, mc_table) == null);
//        Boolean validMainClass = validFields && validClassDeclaration;
//        return validMainClass;
        return true;
    }
...
//        LinkedHashMap parentFields = parent.fields;
//        LinkedHashMap parentMethods = parent.methods;
//        //copy parent's methods and methods in order first
//        classTable.fields.putAll(parentFields);
//        classTable.methods.putAll(parentMethods);
        Boolean validFields = classTable.addFields(varDeclarations);
        Boolean validMethods = classTable.addMethods(methodDeclarations);
        Boolean validClassDeclaration = (classTables.put(c_name, classTable) == null);
        return true;
